...
| **Open WebUI** | Interfaz de IA | Interfaz web amigable para interactuar con modelos de lenguaje locales (LLMs). |
| **LiteLLM** | Proxy de IA | Pasarela unificada para conectar múltiples proveedores de IA y gestionar el acceso a modelos. |
